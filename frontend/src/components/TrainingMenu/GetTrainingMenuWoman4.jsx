    ...
    if (gymType === "ホームジム3") {
      if (frequency === "6回/週") {
        if (volume === "多いのがいい！") {
            ...
            { day: "火曜日", exercises: [{ name: "懸垂", reps: 5, sets: 5, workout_id: 19 }, { name: "腕立て伏せ", reps: 20, sets: 5, workout_id: 16 }] },
            ...
            { day: "金曜日", exercises: [{ name: "懸垂", reps: 5, sets: 5, workout_id: 19 }, { name: "ディップス（椅子）", reps: 20, sets: 5, workout_id: 10 }] },
            ...
            { day: "火曜日", exercises: [{ name: "懸垂", reps: 5, sets: 3, workout_id: 19 }, { name: "腕立て伏せ", reps: 20, sets: 3, workout_id: 16 }] },
            ...
            { day: "金曜日", exercises: [{ name: "懸垂", reps: 5, sets: 3, workout_id: 19 }, { name: "ディップス（椅子）", reps: 20, sets: 3, workout_id: 10 }] },
            ...
            { day: "火曜日", exercises: [{ name: "懸垂", reps: 5, sets: 2, workout_id: 19 }, { name: "腕立て伏せ", reps: 20, sets: 2, workout_id: 16 }] },
            ...
            { day: "金曜日", exercises: [{ name: "懸垂", reps: 5, sets: 2, workout_id: 19 }, { name: "ディップス（椅子）", reps: 20, sets: 2, workout_id: 10 }] },
