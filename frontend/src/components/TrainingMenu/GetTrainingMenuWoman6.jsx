    ...
    if (gymType === "自重のみ") {
      if (frequency === "6回/週") {
        if (volume === "多いのがいい！") {
            ...
            { day: "火曜日", exercises: [{ name: "ディップス（椅子）", reps: 20, sets: 5 }, { name: "腕立て伏せ", reps: 20, sets: 5 }] },
            ...
            { day: "火曜日", exercises: [{ name: "ディップス（椅子）", reps: 20, sets: 3 }, { name: "腕立て伏せ", reps: 20, sets: 3 }] },
            ...
            { day: "火曜日", exercises: [{ name: "ディップス（椅子）", reps: 20, sets: 2 }, { name: "腕立て伏せ", reps: 20, sets: 2 }] },
        ...
        if (volume === "多いのがいい！") {
            ...
            { day: "月曜日", exercises: [{ name: "ヒップスラスト", reps: 10, sets: 5 }, { name: "ブルガリアンスクワット", reps: 12, sets: 5 }, { name: "スクワット", reps: 15, sets: 5 }] },
            { day: "火曜日", exercises: [{ name: "ディップス（椅子）", reps: 20, sets: 5 }, { name: "腕立て伏せ", reps: 20, sets: 5 }] },
            { day: "水曜日", exercises: [{ name: "クランチ", reps: 20, sets: 5 }, { name: "ロシアンツイスト", reps: 20, sets: 5 }, { name: "ウォーキング", duration: "20分" }] },
            { day: "木曜日", exercises: [{ name: "ヒップスラスト", reps: 10, sets: 5 }, { name: "ブルガリアンスクワット", reps: 12, sets: 5 }, { name: "スクワット", reps: 15, sets: 5 }] },
            { day: "金曜日", exercises: [{ name: "ディップス（椅子）", reps: 20, sets: 5 }, { name: "腕立て伏せ", reps: 20, sets: 5 }] },
            ...
            { day: "月曜日", exercises: [{ name: "ヒップスラスト", reps: 10, sets: 3 }, { name: "ブルガリアンスクワット", reps: 12, sets: 3 }, { name: "スクワット", reps: 15, sets: 3 }] },
            { day: "火曜日", exercises: [{ name: "ディップス（椅子）", reps: 20, sets: 3 }, { name: "腕立て伏せ", reps: 20, sets: 3 }] },
            { day: "水曜日", exercises: [{ name: "クランチ", reps: 20, sets: 3 }, { name: "ロシアンツイスト", reps: 20, sets: 3 }, { name: "ウォーキング", duration: "20分" }] },
            { day: "木曜日", exercises: [{ name: "ヒップスラスト", reps: 10, sets: 3 }, { name: "ブルガリアンスクワット", reps: 12, sets: 3 }, { name: "スクワット", reps: 15, sets: 3 }] },
            { day: "金曜日", exercises: [{ name: "ディップス（椅子）", reps: 20, sets: 3 }, { name: "腕立て伏せ", reps: 20, sets: 3 }] },
            ...
            { day: "月曜日", exercises: [{ name: "ヒップスラスト", reps: 10, sets: 2 }, { name: "ブルガリアンスクワット", reps: 12, sets: 2 }, { name: "スクワット", reps: 15, sets: 2 }] },
            { day: "火曜日", exercises: [{ name: "ディップス（椅子）", reps: 20, sets: 2 }, { name: "腕立て伏せ", reps: 20, sets: 2 }] },
            { day: "水曜日", exercises: [{ name: "クランチ", reps: 20, sets: 2 }, { name: "ロシアンツイスト", reps: 20, sets: 2 }, { name: "ウォーキング", duration: "20分" }] },
            { day: "木曜日", exercises: [{ name: "ヒップスラスト", reps: 10, sets: 2 }, { name: "ブルガリアンスクワット", reps: 12, sets: 2 }, { name: "スクワット", reps: 15, sets: 2 }] },
            { day: "金曜日", exercises: [{ name: "ディップス（椅子）", reps: 20, sets: 2 }, { name: "腕立て伏せ", reps: 20, sets: 2 }] },
        ...
        if (volume === "多いのがいい！") {
            ...
            { day: "金曜日", exercises: [{ name: "腕立て伏せ", reps: 20, sets: 5 }, { name: "ディップス（椅子）", reps: 20, sets: 5 }, { name: "ウォーキング", duration: "20分" }] },
            ...
            { day: "金曜日", exercises: [{ name: "腕立て伏せ", reps: 20, sets: 3 }, { name: "ディップス（椅子）", reps: 20, sets: 3 }, { name: "ウォーキング", duration: "20分" }] },
            ...
            { day: "金曜日", exercises: [{ name: "腕立て伏せ", reps: 20, sets: 2 }, { name: "ディップス（椅子）", reps: 20, sets: 2 }, { name: "ウォーキング", duration: "20分" }] },
        ...
        if (volume === "多いのがいい！") {
            ...
            { day: "月曜日", exercises: [{ name: "ヒップスラスト", reps: 10, sets: 5 }, { name: "ブルガリアンスクワット", reps: 12, sets: 5 }, { name: "スクワット", reps: 15, sets: 5 }] },
            { day: "水曜日", exercises: [{ name: "ディップス（椅子）", reps: 20, sets: 5 }, { name: "腕立て伏せ", reps: 20, sets: 5 }] },
            ...
            { day: "月曜日", exercises: [{ name: "ヒップスラスト", reps: 10, sets: 3 }, { name: "ブルガリアンスクワット", reps: 12, sets: 3 }, { name: "スクワット", reps: 15, sets: 3 }] },
            { day: "水曜日", exercises: [{ name: "ディップス（椅子）", reps: 20, sets: 3 }, { name: "腕立て伏せ", reps: 20, sets: 3 }] },
            ...
            { day: "月曜日", exercises: [{ name: "ヒップスラスト", reps: 10, sets: 2 }, { name: "ブルガリアンスクワット", reps: 12, sets: 2 }, { name: "スクワット", reps: 15, sets: 2 }] },
            { day: "水曜日", exercises: [{ name: "ディップス（椅子）", reps: 20, sets: 2 }, { name: "腕立て伏せ", reps: 20, sets: 2 }] },
