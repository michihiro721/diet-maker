      ...
      if (gymType === "ホームジム1") {
        if (frequency === "6回/週") {
          if (volume === "多いのがいい！") {
            ...
            suggestedMenu += "土: ヒップスラスト 12回×5セット, レッグレイズ 10回×5セット, ウォーキング 20分\n";
            suggestedMenu += "日: 休み\n";
            ...
            suggestedMenu += "土: ヒップスラスト 12回×3セット, レッグレイズ 10回×3セット, ウォーキング 20分\n";
            suggestedMenu += "日: 休み\n";
          } else {
            suggestedMenu += "\n**6回/週の軽めメニュー**\n";
            ...
            suggestedMenu += "土: ヒップスラスト 12回×2セット, レッグレイズ 10回×2セット, ウォーキング 20分\n";
            suggestedMenu += "日: 休み\n";
          }
          ...
          if (volume === "多いのがいい！") {
            ...
            suggestedMenu += "火: キックバック 15回×3セット, ダンベルローイング 12回×3セット\n";
            suggestedMenu += "水: バーベルスクワット 10回×3セット, ブルガリアンスクワット 12回×3セット, スクワット 15回×3セット\n";
            suggestedMenu += "木: ショルダープレス 12回×3セット, サイドレイズ 12回×3セット\n";
            ...
            suggestedMenu += "火: キックバック 15回×2セット, ダンベルローイング 12回×2セット\n";
            suggestedMenu += "水: バーベルスクワット 10回×2セット, ブルガリアンスクワット 12回×2セット, スクワット 15回×2セット\n";
            suggestedMenu += "木: ショルダープレス 12回×2セット, サイドレイズ 12回×2セット\n";
