    ...
    if (gymType === "ホームジム2") {
      if (frequency === "6回/週") {
        if (volume === "多いのがいい！") {
            ...
            { day: "水曜日", exercises: [{ name: "ダンベルスクワット", reps: 10, sets: 5 }, { name: "ブルガリアンスクワット", reps: 12, sets: 5 }, { name: "スクワット", reps: 15, sets: 5 }] },
            ...
            { day: "土曜日", exercises: [{ name: "ヒップスラスト", reps: 12, sets: 5 }, { name: "腕立て", reps: 10, sets: 5 }, { name: "ウォーキング", duration: "20分" }] },
            ...
            { day: "水曜日", exercises: [{ name: "ダンベルスクワット", reps: 10, sets: 3 }, { name: "ブルガリアンスクワット", reps: 12, sets: 3 }, { name: "スクワット", reps: 15, sets: 3 }] },
            ...
            { day: "土曜日", exercises: [{ name: "ヒップスラスト", reps: 12, sets: 3 }, { name: "腕立て", reps: 10, sets: 3 }, { name: "ウォーキング", duration: "20分" }] },
            ...
            { day: "水曜日", exercises: [{ name: "ダンベルスクワット", reps: 10, sets: 2 }, { name: "ブルガリアンスクワット", reps: 12, sets: 2 }, { name: "スクワット", reps: 15, sets: 2 }] },
            ...
            { day: "土曜日", exercises: [{ name: "ヒップスラスト", reps: 12, sets: 2 }, { name: "腕立て", reps: 10, sets: 2 }, { name: "ウォーキング", duration: "20分" }] },
        ...
        { day: "金曜日", exercises: [{ name: "ヒップスラスト", reps: 12, sets: 5 }, { name: "腕立て", reps: 10, sets: 5 }, { name: "ウォーキング", duration: "20分" }] },
        ...
        { day: "金曜日", exercises: [{ name: "ヒップスラスト", reps: 12, sets: 3 }, { name: "腕立て", reps: 10, sets: 3 }, { name: "ウォーキング", duration: "20分" }] },
        ...
        { day: "金曜日", exercises: [{ name: "ヒップスラスト", reps: 12, sets: 2 }, { name: "腕立て", reps: 10, sets: 2 }, { name: "ウォーキング", duration: "20分" }] },
        ...
        if (volume === "多いのがいい！") {
            ...
            { day: "月曜日", exercises: [{ name: "ヒップスラスト", reps: 10, sets: 5 }, { name: "ブルガリアンスクワット", reps: 12, sets: 5 }, { name: "ダンベルスクワット", reps: 12, sets: 5 }] },
            { day: "火曜日", exercises: [{ name: "キックバック", reps: 15, sets: 5 }, { name: "ダンベルローイング", reps: 12, sets: 5 }] },
            { day: "木曜日", exercises: [{ name: "ダンベルスクワット", reps: 10, sets: 5 }, { name: "ブルガリアンスクワット", reps: 12, sets: 5 }, { name: "スクワット", reps: 15, sets: 5 }] },
            ...
            { day: "月曜日", exercises: [{ name: "ヒップスラスト", reps: 10, sets: 3 }, { name: "ブルガリアンスクワット", reps: 12, sets: 3 }, { name: "ダンベルスクワット", reps: 12, sets: 3 }] },
            { day: "火曜日", exercises: [{ name: "キックバック", reps: 15, sets: 3 }, { name: "ダンベルローイング", reps: 12, sets: 3 }] },
            { day: "木曜日", exercises: [{ name: "ダンベルスクワット", reps: 10, sets: 3 }, { name: "ブルガリアンスクワット", reps: 12, sets: 3 }, { name: "スクワット", reps: 15, sets: 3 }] },
            ...
            { day: "月曜日", exercises: [{ name: "ヒップスラスト", reps: 10, sets: 2 }, { name: "ブルガリアンスクワット", reps: 12, sets: 2 }, { name: "ダンベルスクワット", reps: 12, sets: 2 }] },
            { day: "火曜日", exercises: [{ name: "キックバック", reps: 15, sets: 2 }, { name: "ダンベルローイング", reps: 12, sets: 2 }] },
            { day: "木曜日", exercises: [{ name: "ダンベルスクワット", reps: 10, sets: 2 }, { name: "ブルガリアンスクワット", reps: 12, sets: 2 }, { name: "スクワット", reps: 15, sets: 2 }] },
        ...
        if (volume === "多いのがいい！") {
          createMenu("3回/週のハードメニュー", [
            { day: "月曜日", exercises: [{ name: "ヒップスラスト", reps: 10, sets: 5 }, { name: "ブルガリアンスクワット", reps: 12, sets: 5 }, { name: "ダンベルスクワット", reps: 12, sets: 5 }] },
            { day: "水曜日", exercises: [{ name: "デットリフト", reps: 12, sets: 5 }, { name: "バーベルロー", reps: 12, sets: 5 }] },
            { day: "金曜日", exercises: [{ name: "クランチ", reps: 20, sets: 5 }, { name: "ロシアンツイスト", reps: 20, sets: 5 }, { name: "ウォーキング", duration: "20分" }] },
          ...
          createMenu("3回/週の標準メニュー", [
            { day: "月曜日", exercises: [{ name: "ヒップスラスト", reps: 10, sets: 3 }, { name: "ブルガリアンスクワット", reps: 12, sets: 3 }, { name: "ダンベルスクワット", reps: 12, sets: 3 }] },
            { day: "水曜日", exercises: [{ name: "デットリフト", reps: 12, sets: 3 }, { name: "バーベルロー", reps: 12, sets: 3 }] },
            { day: "金曜日", exercises: [{ name: "クランチ", reps: 20, sets: 3 }, { name: "ロシアンツイスト", reps: 20, sets: 3 }, { name: "ウォーキング", duration: "20分" }] },
          ...
          createMenu("3回/週の軽めメニュー", [
            { day: "月曜日", exercises: [{ name: "ヒップスラスト", reps: 10, sets: 2 }, { name: "ブルガリアンスクワット", reps: 12, sets: 2 }, { name: "ダンベルスクワット", reps: 12, sets: 2 }] },
            { day: "水曜日", exercises: [{ name: "デットリフト", reps: 12, sets: 2 }, { name: "バーベルロー", reps: 12, sets: 2 }] },
            { day: "金曜日", exercises: [{ name: "クランチ", reps: 20, sets: 2 }, { name: "ロシアンツイスト", reps: 20, sets: 2 }, { name: "ウォーキング", duration: "20分" }] },
