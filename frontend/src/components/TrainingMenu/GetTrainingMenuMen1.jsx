      ...
      if (frequency === "6回/週") {
        if (volume === "多いのがいい！") {
          createMenu("6回/週のハードメニュー", [
            ...
            { day: "火曜日", exercises: ["デットリフト 10回×5セット", "ダンベルローイング 10回×5セット", "ラットプルダウン 10回×5セット"] },
          ...
          createMenu("6回/週の標準メニュー", [
            ...
            { day: "火曜日", exercises: ["デットリフト 10回×3セット", "ダンベルローイング 10回×3セット", "ラットプルダウン 10回×3セット"] },
          ...
          createMenu("6回/週の軽めメニュー", [
            ...
            { day: "火曜日", exercises: ["デットリフト 10回×2セット", "ダンベルローイング 10回×2セット", "ラットプルダウン 10回×2セット"] },
        ...
        if (volume === "多いのがいい！") {
          createMenu("4回/週のハードメニュー", [
            ...
            { day: "木曜日", exercises: ["デットリフト 10回×5セット", "ダンベルローイング 10回×5セット", "ラットプルダウン 10回×5セット"] },
          ...
          createMenu("4回/週の標準メニュー", [
            ...
            { day: "木曜日", exercises: ["デットリフト 10回×3セット", "ダンベルローイング 10回×3セット", "ラットプルダウン 10回×3セット"] },
          ...
          createMenu("4回/週の軽めメニュー", [
            ...
            { day: "木曜日", exercises: ["デットリフト 10回×2セット", "ダンベルローイング 10回×2セット", "ラットプルダウン 10回×2セット"] },
        ...
        if (volume === "多いのがいい！") {
          createMenu("3回/週のハードメニュー", [
            { day: "月曜日", exercises: ["ベンチプレス 10回×5セット", "インクラインダンベルフライ 10回×5セット", "ペックフライ 10回×5セット"] },
            { day: "水曜日", exercises: ["バーベルスクワット 10回×5セット", "レッグプレス 10回×5セット", "レッグカール 10回×5セット"] },
            { day: "金曜日", exercises: ["デットリフト 10回×5セット", "ダンベルローイング 10回×5セット", "ラットプルダウン 10回×5セット"] },
          ...
          createMenu("3回/週の標準メニュー", [
            { day: "月曜日", exercises: ["ベンチプレス 10回×3セット", "インクラインダンベルフライ 10回×3セット", "ペックフライ 10回×3セット"] },
            { day: "水曜日", exercises: ["バーベルスクワット 10回×3セット", "レッグプレス 10回×3セット", "レッグカール 10回×3セット"] },
            { day: "金曜日", exercises: ["デットリフト 10回×3セット", "ダンベルローイング 10回×3セット", "ラットプルダウン 10回×3セット"] },
            { day: "火木土日曜日", exercises: ["休み"] }
          ]);
        } else {
          createMenu("3回/週の軽めメニュー", [
            { day: "月曜日", exercises: ["ベンチプレス 10回×2セット", "インクラインダンベルフライ 10回×2セット", "ペックフライ 10回×2セット"] },
            { day: "水曜日", exercises: ["バーベルスクワット 10回×2セット", "レッグプレス 10回×2セット", "レッグカール 10回×2セット"] },
            { day: "金曜日", exercises: ["デットリフト 10回×2セット", "ダンベルローイング 10回×2セット", "ラットプルダウン 10回×2セット"] },
            { day: "火木土日曜日", exercises: ["休み"] }
          ]);
        }
      }
